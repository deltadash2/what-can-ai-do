...
Welcome to WCAD! Dive into the list of AI tools, featuring top generative AI tools and LLMs. From art to chatbots, and from writing to data analysis, WCAD will get you covered. Browse through the collection and discover new AI tools that can:

> - Create stunning artwork and music
> - Understand and respond to human language
> - Analyze and make predictions from data
> - And more!

Contribute to my repository with your product, help me grow the WCAD community! Enjoy it?— Send a PR to this repository! Cheers!
...
- [Harmonai](https://www.harmonai.org/) - A community-driven organization releasing open-source generative audio tools to make music production more accessible and fun for everyone.
...
- [Auferet](https://auferet.com/) - Play solo text adventures and tabletop-style RPGs with an AI game master that keeps a lasting memory of your world.
